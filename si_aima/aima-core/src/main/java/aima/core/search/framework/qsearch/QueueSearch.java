...
public abstract class QueueSearch<S, A> {
	...
	// Ejercicio 5 - 6
	public final static String METRIC_NODES_DUPLICATED_IN_FRONTIER = "nodesDuplicatedInFrontier";
	public final static String METRIC_NODES_EXPANDED_REINSERTED_IN_FRONTIER = "nodesExpandedReinsertedInFrontier";
	public final static String METRIC_TIME_TAKEN = "timeTaken";
